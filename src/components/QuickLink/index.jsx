...
export default function QuickLink({ scrollbar }) {
    ...
    function activeQuicklink({ offset }) {
        ...
        let container = ["#about", "#resume", "#portfolio", "#contact"]
    ...
    return (
        <div ref={containerRef} className="fixed right-[1rem] translate-x-[0%] translate-y-[-50%] z-[10]">
            <div className="flex flex-col gap-1 w-[max-content] h-[max-content]">
                <Button scrollIntoView={() => scrollIntoView("#about")} name="About Me"></Button>
                <Button scrollIntoView={() => scrollIntoView("#resume")} name="My Resume"></Button>
                <Button scrollIntoView={() => scrollIntoView("#portfolio")} name="Portfolio"></Button>
                <Button scrollIntoView={() => scrollIntoView("#contact")} name="Contact Me"></Button>
            </div>
        </div>
    )
}
...
const Button = ({ scrollIntoView, name }) => {
    return (
        <button onClick={scrollIntoView}
            ...
            <GoPrimitiveDot className="text-[16px] absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]" />
