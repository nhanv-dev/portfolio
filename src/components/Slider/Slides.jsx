...
export function WelcomeSlide({ active }) {
    ...
    return (
        <div className={active + " slide-text p-10 opacity-0 absolute left-0 top-0 transition-all delay-100 duration-[300ms] ease-in-out w-full"}>
            <div className="w-full h-full flex items-center mb-5">
                ...
                <span className="font-[600] text-[.8rem] md:text-[1rem] tracking-[2px] capitalize color-white opacity-80">Welcome to my world</span>
            </div>
            ...
            <a className="hover:scale-[1.05] transition-all duration-300 ease-in-out inline-flex items-center justify-center gap-3 rounded-full px-3 py-2 max-w-[250px] border-[2px] border-[rgba(255,255,255,0.2)] focus:outline-none">
                <span className="w-[30px] h-[30px] border-2 bg-white text-black rounded-full flex items-center justify-center">
...
export function SpotifySlide({ active }) {
    ...
    return (
        <div className={active + " slide-text p-10 opacity-0 absolute left-0 top-0 transition-all delay-100 duration-[300ms] ease-in-out w-full"}>
            <div className="w-full h-full flex items-center mb-5">
                <span className="inline-block mt-1 mr-5 w-[40px] h-[2px] bg-[rgba(255,255,255,.1)]"></span>
                <span className="font-[600] text-[.8rem] md:text-[1rem] tracking-[2px] capitalize color-white opacity-80">Project #01</span>
            </div>
...
export function TodoSlide({ active }) {
    ...
    return (
        <div className={active + " slide-text p-10 opacity-0 absolute left-0 top-0 transition-all delay-100 duration-[300ms] ease-in-out w-full"}>
            <div className="w-full h-full flex items-center mb-5">
                <span className="inline-block mt-1 mr-5 w-[40px] h-[2px] bg-[rgba(255,255,255,.1)]"></span>
                <span className="font-[600] text-[.8rem] md:text-[1rem] tracking-[2px] capitalize color-white opacity-80">Project #02</span>
            </div>
            <svg width="100%" height="100px">
...
export function NoonpostSlide({ active }) {
    return (
        <div className={active + " slide-text p-10 opacity-0 absolute left-0 top-0 transition-all delay-100 duration-[300ms] ease-in-out w-full"}>
            <div className="w-full h-full flex items-center mb-5">
                <span className="inline-block mt-1 mr-5 w-[40px] h-[2px] bg-[rgba(255,255,255,.1)]"></span>
                <span className="font-[600] text-[.8rem] md:text-[1rem] tracking-[2px] capitalize color-white opacity-80">Project #03</span>
            </div>
            <svg width="100%" height="100px">
                <text x="0%" y="60%" textAnchor="left">
                    Noonpost.
...
export function ElectronicSlide({ active }) {
    return (
        <div className={active + " slide-text p-10 opacity-0 absolute left-0 top-0 transition-all delay-100 duration-[300ms] ease-in-out w-full"}>
            <div className="w-full h-full flex items-center mb-5">
                <span className="inline-block mt-1 mr-5 w-[40px] h-[2px] bg-[rgba(255,255,255,.1)]"></span>
                <span className="font-[600] text-[.8rem] md:text-[1rem] tracking-[2px] capitalize color-white opacity-80">Project #04</span>
            </div>
            <svg width="100%" height="100px">
                <text x="0%" y="60%" textAnchor="left">
...
export function ChitchatSlide({ active }) {
    return (
        <div className={active + " slide-text p-10 opacity-0 absolute left-0 top-0 transition-all delay-100 duration-[300ms] ease-in-out w-full"}>
            <div className="w-full h-full flex items-center mb-5">
                <span className="inline-block mt-1 mr-5 w-[40px] h-[2px] bg-[rgba(255,255,255,.1)]"></span>
                <span className="font-[600] text-[.8rem] md:text-[1rem] tracking-[2px] capitalize color-white opacity-80">Project #05</span>
            </div>
            <svg width="100%" height="100px">
                <text x="0%" y="60%" textAnchor="left">
                    Chitchat - App Chat
...
export function SnakeSlide({ active }) {
    return (
        <div className={active + " slide-text p-10 opacity-0 absolute left-0 top-0 transition-all delay-100 duration-[300ms] ease-in-out w-full"}>
            <div className="w-full h-full flex items-center mb-5">
                <span className="inline-block mt-1 mr-5 w-[40px] h-[2px] bg-[rgba(255,255,255,.1)]"></span>
                <span className="font-[600] text-[.8rem] md:text-[1rem] tracking-[2px] capitalize color-white opacity-80">Project #06</span>
            </div>
            <svg width="100%" height="100px">
                <text x="0%" y="60%" textAnchor="left">
